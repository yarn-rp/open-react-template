...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "Blueprint's AI assistant has completely transformed our team workflow. It joins meetings, manages our tasks, schedules everything, and provides insights we would have missed. It's like having the smartest team member who never sleeps.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "As a product manager, Blueprint's AI assistant has been invaluable. It manages our entire workflow - from meeting notes to task assignments to scheduling. The automation has saved us hours every week.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "Our remote team workflow used to be chaotic, but Blueprint changed everything. The AI assistant handles our meetings, manages tasks across platforms, and keeps everyone coordinated. It's like having a brilliant operations manager.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "Blueprint's ability to understand our complex workflows and automate tasks is incredible. As a tech lead, I appreciate how it keeps our team organized and productive across all our tools and platforms.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "Blueprint has revolutionized how we manage client projects. The AI assistant handles meeting coordination, task tracking, and client communication. Our clients are impressed with our efficiency and organization.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "The seamless integration makes Blueprint's AI assistant feel like a natural part of our team. It's proactive without being intrusive, and its automation has helped us make better decisions and work more efficiently.",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "Blueprint's contextual understanding is remarkable. It doesn't just automate tasks - it actually comprehends our workflow and provides intelligent suggestions. It's like having a brilliant operations manager.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "Blueprint has made our executive operations so much more efficient. It captures key decisions, tracks action items across all departments, and provides intelligent summaries. The automation feels seamless and professional.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "Blueprint's seamless integration into our existing tools is impressive. No technical setup required - it just works. The automation is intelligent and the insights are always spot-on.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
            See what teams are saying about Blueprint
          </h2>
          <p className="text-lg text-indigo-200/65">
            Join thousands of teams who have transformed their workflow with Blueprint's custom AI assistants.
          </p>
        </div>
